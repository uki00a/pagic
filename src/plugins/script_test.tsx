...
Deno.test('[script]', async () => {
  ...
  asserts.assertEquals(
    ...
    '<script src="https://esm.sh/react@16.13.1/umd/react.production.min.js" data-reactroot=""></script><script src="https://esm.sh/react-dom@16.13.1/umd/react-dom.production.min.js" data-reactroot=""></script><script type="module" src="/index.js" data-reactroot=""></script>',
  );
